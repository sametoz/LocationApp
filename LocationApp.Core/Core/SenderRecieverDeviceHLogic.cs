...
namespace LocationApp.Core.Core
{
    ...
    {
        public string SetMobilBeacon(List<SenderRecieverDeviceMobilBeaconDto> data)
        {
            try
            {
                senderrecieverdevicemobilbeacon mobilBeacon = null;
                foreach (var item in data)
                {
                    mobilBeacon = new senderrecieverdevicemobilbeacon();
                    mobilBeacon.ID = 0;
                    mobilBeacon.DeviceID = item.DeviceID; ;
                    mobilBeacon.CreationDate = item.CreationDate;
                    mobilBeacon.Device_Name_1 = item.Device_Name_1;
                    mobilBeacon.Device_Name_2 = item.Device_Name_2;
                    mobilBeacon.Device_Name_3 = item.Device_Name_3;
                    mobilBeacon.Device_Name_4 = item.Device_Name_4;
                    mobilBeacon.Device_Name_5 = item.Device_Name_5;
                    mobilBeacon.Device_Name_6 = item.Device_Name_6;
                    mobilBeacon.Device_Distance_1 = item.Device_Distance_1;
                    mobilBeacon.Device_Distance_2 = item.Device_Distance_2;
                    mobilBeacon.Device_Distance_3 = item.Device_Distance_3;
                    mobilBeacon.Device_Distance_4 = item.Device_Distance_4;
                    mobilBeacon.Device_Distance_5 = item.Device_Distance_5;
                    mobilBeacon.Device_Distance_6 = item.Device_Distance_6;
                    mobilBeacon.Device_RSS_1 = item.Device_RSS_1;
                    mobilBeacon.Device_RSS_2 = item.Device_RSS_2;
                    mobilBeacon.Device_RSS_3 = item.Device_RSS_3;
                    mobilBeacon.Device_RSS_4 = item.Device_RSS_4;
                    mobilBeacon.Device_RSS_5 = item.Device_RSS_5;
                    mobilBeacon.Device_RSS_6 = item.Device_RSS_6;
                    mobilBeacon.Point_Location = item.Point_Location;
                }
